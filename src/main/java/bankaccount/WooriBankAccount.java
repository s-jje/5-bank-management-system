...
public class WooriBankAccount extends BankAccount {
    ...
    public WooriBankAccount(String name, String id, String password, String bankName, String accountNumber, long balance) {
        super(name, id, password, bankName, accountNumber, balance, 9.51294e-10, 1000); // 3.0%
    }
                        ...
                        if (amount > 0) {
                            ...
                            if (input.equalsIgnoreCase("y") || input.equalsIgnoreCase("yes")) {
                                if (balance >= amount) {
                                    ...
                                    System.out.printf("%nTransfer successful! Transfer fee %s.%n", MoneyFormatter.formatToWon(transferFee));
                                    break;
                                } else {
