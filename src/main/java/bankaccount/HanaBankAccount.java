...
public class HanaBankAccount extends BankAccount {
    ...
    public HanaBankAccount(String name, String id, String password, String bankName, String accountNumber, long balance) {
        super(name, id, password, bankName, accountNumber, balance, 6.34196e-10, 700); // 2.0%
    }
            ...
            if (getBalance() > 0) {
                ...
                if (num == 1) {
                    ...
                    if (money > 0 && getBalance() >= money) {
                        ...
                        System.out.println("[" + toBankAccount.getName() + "님께 " + MoneyFormatter.formatToWon(money) + "원 송금이 완료되었습니다.(수수료 " + MoneyFormatter.formatToWon(transferFee) + "원)");
                        break;
                    } else {
                        System.out.println("=======================================");
